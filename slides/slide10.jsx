...
import impactoNegocioTitle from "../assets/slide10-negocio-title.png";
...
const impacts = [
  {
    number: "01",
    title: "Fidelizacion",
    detail: "Los visitantes tienen un motivo para volver, acumular y canjear.",
    stat: "Recurrencia",
    accent: CYAN,
  },
  {
    ...
    detail: "Cada huella ayuda a entender habitos, categorias y preferencias.",
    stat: "Medicion",
    accent: BLUE,
  },
  {
    number: "03",
    title: "Valor ESG",
    detail: "La sostenibilidad deja de ser discurso y se vuelve impacto trazable.",
    stat: "Diferencial",
    accent: GREEN,
  },
];

function Slide10Decor() {
  const dots = [
...
function ImpactCard({ item, index }) {
  return (
    <motion.div
      className="relative flex h-[188px] flex-col justify-between overflow-hidden rounded-[1.45rem] border border-white bg-white/86 px-6 py-6 backdrop-blur-sm"
      style={{
      ...
      <div className="mb-6 flex items-end justify-between gap-8">
        <div>
          ...
          <h2 className="mt-3 text-[2.05rem] font-black leading-[1.02] tracking-normal" style={{ color: INK }}>
            La sostenibilidad se vuelve ventaja competitiva.
          </h2>
        </div>
...
function Slide10Component() {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <motion.img
        src={impactoNegocioTitle}
        alt="Impacto en el negocio"
        className="absolute left-1/2 top-1/2 z-30 w-[870px] max-w-none select-none"
