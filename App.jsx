  ...
  return (
    <div className="mt-2 grid max-w-[840px] grid-cols-[0.88fr_1.12fr] items-center gap-7">
      <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="relative flex items-center justify-start">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.75 }} className="absolute inset-0">
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-6xl font-bold leading-none" style={{ color: BRAND.yellowText }}>4%</span>
          <span className="absolute left-1/2 top-[calc(50%+42px)] -translate-x-1/2 text-xs font-semibold uppercase tracking-[0.16em]" style={{ color: BRAND.muted }}>usa IA</span>
        </motion.div>
      </motion.div>
