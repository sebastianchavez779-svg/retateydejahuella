...
export default function Presentation() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#eef0f4] p-6">
      <main className="relative aspect-video w-[min(94vw,calc(84vh*16/9))] max-w-[1280px] overflow-hidden rounded-[2rem] bg-[#f7f7f9] shadow-[0_30px_100px_rgba(20,20,40,0.18)]">
      <main className="relative aspect-video w-full max-w-[1280px] overflow-hidden rounded-[2rem] bg-[#f7f7f9] shadow-[0_30px_100px_rgba(20,20,40,0.18)]">
