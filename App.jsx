      ...
      <div className="mt-0 grid max-w-[840px] grid-cols-[0.88fr_1.12fr] items-center gap-7">
        <div className="relative flex items-center justify-start">
          ...
          <div className="relative flex h-[225px] w-[225px] items-center justify-center">
            <div className="h-[190px] w-[190px] rounded-full border-[26px]" style={{ borderColor: "rgba(191,191,191,0.16)" }} />
            <div className="absolute left-1/2 top-[20px] h-[26px] w-[46px] -translate-x-1/2 rounded-full" style={{ background: "linear-gradient(90deg, rgba(115,0,225,0.92), rgba(255,199,64,0.82))" }} />
